...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("skillatorBackOffice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("skillatorBackOffice");
        ...
        config.getMapConfigs().put("it.south.dev.skillator.backoffice.domain.*", initializeDomainMapConfig(jHipsterProperties));
